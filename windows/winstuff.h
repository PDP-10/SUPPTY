...
#define PUTTY_REG_POS "Software\\LivingComputerMuseum\\SuPuTTY"
#define PUTTY_REG_PARENT "Software\\LivingComputerMuseum"
#define PUTTY_REG_PARENT_CHILD "SuPuTTY"
#define PUTTY_REG_GPARENT "Software"
#define PUTTY_REG_GPARENT_CHILD "LivingComputerMuseum"
 ...
 */
#define FILTER_KEY_FILES ("SuPuTTY Private Key Files (*.ppk)\0*.ppk\0" \
			      "All Files (*.*)\0*\0\0\0")
